...
function testFun(record, trig)
{
    console.log("CB TRIG")
    posts = rFeed.getElementsByClassName("w-full m-0")

    for(let i = 0; i < posts.length;i++)
    {
        pTitle = posts[i].getAttribute("aria-label")
        if(typeof pTitle !== "undefined" && pTitle !== null)
        {
            sScore = analyzer.analyze(pTitle)
            //console.log(sScore)
...
rFeed = document.getElementsByTagName("shreddit-feed")[0]

if(typeof rFeed !== "undefined")
{
    obs = new MutationObserver(testFun)
    obs.observe(rFeed, {"subtree": true, "childList":true})
    testFun()
}
